...
int main()
{
    try
    {
        ...
        osl::FileBase::getFileURLFromSystemPath("presentation.pdf", sOutputUrl);
        ...
        // L"file:\\D:\\resources\\example.pptx"
        css::uno::Reference<css::lang::XComponent> xComponent = xComponentLoader->loadComponentFromURL(L"file:\\D:\\resources\\p2.pptx", "_blank", 0, loadProperties);
