...
int main()
{
    try
    {
        ...
        osl::FileBase::getFileURLFromSystemPath("text.pdf", sOutputUrl);
        ...
        // L"file:\\D:\\resources\\example.docx"
        css::uno::Reference<css::lang::XComponent> xComponent = xComponentLoader->loadComponentFromURL(L"file:\\D:\\resources\\text.docx", "_blank", 0, loadProperties);
